...
if len(API_HASH) == 0:
    ...
    exit()
BOT_TOKEN = environ.get('BOT_TOKEN', '7053221934:AAFuZo3H9Nx48aCdCcGPUso7FxEgbJVhsOo')
if len(BOT_TOKEN) == 0:
...
# Bot Admins
ADMINS = environ.get('ADMINS', '6987799874')
if len(ADMINS) == 0:
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1002097824887')
...
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1002230216441")
